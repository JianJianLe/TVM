...
//    public String ticketDesc="" +
//            "[LeftSmall]>1.此凭条为儿童（身高1.4米以下） 剪发专用凭证；\n" +
//            "[LeftSmall]>2.凭此凭条可以在本店享受专业剪发一次，复印无效；\n" +
//            "[LeftSmall]>3.本凭条仅可在购买本店使用；\n" +
//            "[LeftSmall]>4.此凭条不记名，不挂失，不能兑换现金，用完即止；\n" +
//            "[LeftSmall]>5.此凭条从购买之日起，有效期为当天，过期作废；\n" +
//            "[LeftSmall]>6.本公司可能在法律允许范围内对此细则作出适当调整。";
