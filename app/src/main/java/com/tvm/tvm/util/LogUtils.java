...
public class LogUtils {
    ...
    private static String MYLOGFILEName = "TVM_Log.txt";// 本类输出的日志文件名称
    private static SimpleDateFormat myLogSdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");// 日志的输出格式
    private static SimpleDateFormat logFileName = new SimpleDateFormat("yyyy-MM-dd");// 日志文件格式

    private static String getPathDir(){
        return FolderUtil.getDefaultLogPath();
    }
    ...
    private static void writeLogtoFile(String mylogtype, String tag, String text) {// 新建或打开日志文件
        ...
        File dirsFile = new File(getPathDir());
    ...
    public static void delFile() {// 删除日志文件
        String needDelFiel = logFileName.format(getDateBefore());
        File dirPath = new File(getPathDir());
